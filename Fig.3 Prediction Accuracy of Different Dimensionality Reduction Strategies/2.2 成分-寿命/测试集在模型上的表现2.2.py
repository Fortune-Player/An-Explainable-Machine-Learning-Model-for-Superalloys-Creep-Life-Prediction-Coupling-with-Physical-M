...
def model2():
    ...
    # 拟合线性模型
    rf_model = RandomForestRegressor(max_depth=20, n_estimators=70, random_state=42, n_jobs=-1)
    ...
    # 保存计算的机器学习模型
    # joblib.dump(rf_model, '2.2模型.pkl')
...
a = 0
while a < 0.95:
    a, b, trainset, testset, rfmodel, trainresult, testresult = model2()
    if a < min(r2):
        r2.append(a)
